 ...
 */
if (class_exists('Vibrato\\Classes\\Theme')) {
    $Theme = new Vibrato\Classes\Theme();
    $Theme->add_filters();
    $Theme->add_actions();
 ...
 */
if (class_exists('Vibrato\\Classes\\ThemeCarbonFields')) {
    ...
    $ThemeCarbonFields = new Vibrato\Classes\ThemeCarbonFields();
